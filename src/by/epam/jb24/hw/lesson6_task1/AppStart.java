...
public class AppStart {
	...
	public static void main(String[] args) {
		...
		System.out.println("");
		System.out
				.println("--------------------------------------Average score of Groups-----------------------------------------------------");
		System.out.println("Average score for " + group01.getGroupId() + " = "
				+ group01.averageGroupScore());
		System.out.println("Average score for " + group02.getGroupId() + " = "
				+ group02.averageGroupScore());
		System.out.println("Average score for " + group03.getGroupId() + " = "
				+ group03.averageGroupScore());

		// Print average score for each Students
		System.out.println("");
		System.out
				.println("--------------------------------------Average score of Students-----------------------------------------------------");
			...
			if (!(arrListOfGroup[i] == null)) {
				for (int j = 0; j < arrListOfGroup.length; j++)
					if (!(arrListOfGroup[i].getArrStudentGroup()[j] == null)) {
						System.out
								.println("Average score for "
										+ arrListOfGroup[i]
												.getArrStudentGroup()[j].firstName
										+ " "
										+ arrListOfGroup[i]
												.getArrStudentGroup()[j].lastName
										+ " = "
										+ arrListOfGroup[i]
												.getArrStudentGroup()[j]
												.averageStudentScore());
					}
			}
		}
		...
		System.out.println("");
		System.out
				.println("------------------------------------Number of high Achiever-------------------------------------------------");
		System.out.println("Number of high Achiever is "
				+ highAchiever(arrListOfGroup));

		// Print Number of students who has score 2
		System.out.println("");
		System.out
				.println("------------------------------------Number of Bad students-------------------------------------------------");
		System.out.println("Number of students who has 2 is "
				+ counOfBadStudent(arrListOfGroup));

		// Print List of Students
		System.out.println("");
		System.out
				.println("------------------------------------List of Students with his score---------------------------------------------");
		for (int i = 0; i < arrListOfGroup.length; i++) {
			if (!(arrListOfGroup[i] == null)) {
				for (int j = 0; j < arrListOfGroup.length; j++) {
					if (!(arrListOfGroup[i].getArrStudentGroup()[j] == null)) {
						System.out
								.println(arrListOfGroup[i].getGroupId()
										+ ": "
										+ arrListOfGroup[i]
												.getArrStudentGroup()[j].firstName
										+ " "
										...
										+ " "
										+ arrListOfGroup[i]
												.getArrStudentGroup()[j].scoreBiology
										+ " "
										+ arrListOfGroup[i]
												.getArrStudentGroup()[j]
												.getChemistry()
			...
			if (!(arrListOfGroup[i] == null)) {
				...
				for (int j = 0; j < group.getArrStudentGroup().length; j++) {
					if (!(group.getArrStudentGroup()[j] == null)) {
						...
						checkBadScore = stud.toFindBadStudent();
